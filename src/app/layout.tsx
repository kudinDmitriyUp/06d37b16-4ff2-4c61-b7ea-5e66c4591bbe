...
export const metadata: Metadata = {
  title: "HulaFit Training Center - Fun Hula Hoop Fitness Classes",
  description: "Transform your fitness with dynamic hula hoop training classes. Build core strength, improve flexibility & boost cardio in a fun, supportive environment.",
  keywords: "hula hoop fitness, fitness classes, core training, cardio workout, strength training, flexibility, dance fitness",
  openGraph: {
    title: "HulaFit Training Center - Fun Hula Hoop Fitness Classes",
    description: "Transform your fitness with dynamic hula hoop training classes. Build core strength, improve flexibility & boost cardio in a fun, supportive environment.",
    siteName: "HulaFit Training Center",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SiMkwDFagCJqdtr8SgryeO9Cj/uploaded-1763394196565-qm73vhf4.jpg",
      alt: "HulaFit Training Center - Hula Hoop Fitness Classes"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "HulaFit Training Center - Fun Hula Hoop Fitness Classes",
    description: "Transform your fitness with dynamic hula hoop training classes. Build core strength, improve flexibility & boost cardio.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SiMkwDFagCJqdtr8SgryeO9Cj/uploaded-1763394196565-qm73vhf4.jpg"]
  },
  robots: {
    index: true,
    follow: true
